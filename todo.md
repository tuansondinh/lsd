...
- [ ] Verify that custom subagents and skills work
- [ ] Plan mode: automatically switch to a high reasoning model after plan is generated (user-configurable in settings); once plan is done, show a dialog for the user to approve and switch to bypass or auto mode
