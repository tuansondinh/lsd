...
const LSD_ARGUMENTS: AutocompleteItem[] = [
    ...
    { value: "telegram autoconnect", label: "telegram autoconnect", description: "Manage Telegram relay auto-connect setting" },
    { value: "telegram autoconnect on", label: "telegram autoconnect on", description: "Enable auto-connect on startup" },
    { value: "telegram autoconnect off", label: "telegram autoconnect off", description: "Disable auto-connect on startup" },
    { value: "telegram autoconnect status", label: "telegram autoconnect status", description: "Show auto-connect setting" },
];
...
export default function RemoteQuestionsExtension(pi: ExtensionAPI): void {
    ...
    pi.on("extension_ui_request", (event) => relay.onExtensionUiRequest(event));
    pi.on("extension_ui_response", (event) => relay.onExtensionUiResponse(event));
    ...
    void relay.autoConnectIfEnabled();
